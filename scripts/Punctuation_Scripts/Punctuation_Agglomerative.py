...
values,features = pickle.load(open('../pickle/punctuation/punctuation.pkl','rb'))
...
def plot_clustering(X_red, labels, title=None):
    ...
    plt.savefig('../plots/agglomerative_average_1gramsfeatures.png')


# In[204]:


plot_clustering(reduced_data, AC.labels_, 'Agglomerative Clustering with single Linkage. K=5')
